...
try{
 ...
 if($_POST){
  ...
  if($ogr_ad!="" && $bdurum_ogrenci_id!="" && $ogr_durum!=""){
    $sonuc = $conn->exec("UPDATE calisandurum SET  calisan_ad ='$ogr_ad', calisan_durum='$ogr_durum' WHERE durum_id='$bdurum_ogrenci_id'");
  }else{
...
<div class="table-responsive">
  ...
  <th style='text-align:center;'>Çalışan Durumu</th>
...
try{
 ...
 $query = $conn->query("SELECT * FROM calisandurum ");

 while ($row = $query->fetch()) {
  echo "<tr ><td style='text-align:center;'>".$row['calisan_ad']."</td>";
  echo "<td style='text-align:center;'>".$row['calisan_durum']."</td>";
  echo "<td style='text-align:center;'> <button class='calisandurumduzen' id=".$row['durum_id'].">Düzenle</button></td></tr>";
}
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">ÇalışanDurumu Düzenle</h5>
    ...
    <label for="fdurum">Çalışan Durumu</label>

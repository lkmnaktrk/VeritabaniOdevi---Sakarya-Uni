...
try{
 ...
 if($basvuru!="" ){
$query=$conn->exec("insert into tamirolcaklar (tamir_ad,tamir_neden)VALUES('$basvuru','$basvuru2')");
if($query)
            ...
            <i class="fa fa-bars"></i>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Tamir Olacak Ekle</h1>
                    </div>
...
?>
  <form action="ekle.php" method="post">
    ...
    <label for="fname">Tamir Ad</label>
    <input type="text" id="ad" name="ad"  placeholder="ad">
    <label for="fname">Tamir Neden</label>
    <input type="text" id="neden" name="neden"  placeholder="Tamir Neden">

...
try{
 ...
 if($basvuru!="" ){
$query=$conn->exec("insert into calisanlar (calisanlar_ad )VALUES('$basvuru')");
if($query)
            ...
            <i class="fa fa-bars"></i>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Çalışan Ekle</h1>
                    </div>
...
?>
  <form action="ekle.php" method="post">
    ...
    <label for="fname">Çalışan Ad</label>
    <input type="text" id="ad" name="ad"  placeholder="Çalışan Ad">

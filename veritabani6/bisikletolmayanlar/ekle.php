...
try{
 ...
 if($yazili!="" ){
$query=$conn->exec("insert into bisikletolmayanlar (parca_ad,parca_fiyat) VALUES('$yazili','$yazili3')");
if($query)
...
?>
  <form action="ekle.php" method="post">
    ...
    <label for="fname">Parça Ad</label>
    <input type="text" id="ad" name="ad"  placeholder="Parça Adı">
    <label for="fname">Parça Fiyat</label>
    <input type="text" id="fiyat" name="fiyat"  placeholder="Parça Fiyatı">

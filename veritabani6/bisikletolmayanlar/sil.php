...
try{
 ...
 if($_POST) 
		...
		if($sonuc = $conn ->query("DELETE FROM bisikletolmayanlar WHERE olmayan_id=$id")==true){
            ...
            <i class="fa fa-bars"></i>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Bisiklet Olmayan Sil</h1>
                    </div>
...
echo "<form form action='sil.php' method='post'><td style='text-align:center;'> <input type='hidden' name='id'value='".$row['olmayan_id']."'> <input type='submit'value='Sil' ></form>";
}

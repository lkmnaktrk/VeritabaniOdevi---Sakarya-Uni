...
try{
 ...
 if($basvuru!="" ){
$query=$conn->exec("insert into bisiklet (bisiklet_ad,bisiklet_adres) VALUES('$basvuru','$basvuru3')");
if($query)
            ...
            <i class="fa fa-bars"></i>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Bisiklet  Ekle</h1>
                    </div>
...
?>
  <form action="ekle.php" method="post">
    ...
    <label for="fname">Bisiklet Ad</label>
    <input type="text" id="ad" name="ad"  placeholder="ad">
    <label for="fname">Bisiklet Adres</label>
    <input type="text" id="fiyat" name="fiyat"  placeholder="Adres">
